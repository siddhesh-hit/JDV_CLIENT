...
const Individualinsurancepersonaldetails4 = () => {
  ...
  const fetchData = async () => {
    await fetch(`${admin}/maternity`)
      .then((e) => e.json())
      .then((res) => setMaternity(res.data))
  ...
  useEffect(() => {
    if (!visited) {
      const beforeOnLoad = maternity.map((val) => ({
        _id: val._id,
        value: false,
      }));
      setArr(beforeOnLoad);
      ...
      if (stored) {
        setArr(stored.maternity_condition);
      }
    }
  }, [maternity]);
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      setArr(JSON.parse(stored).maternity_condition || []);
      setVisited(JSON.parse(stored).maternity_condition_visit);
    }
  }, []);
              ...
              <div className="row form_abcd">
                <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 mb-3">
                  ...
                  <div className="row">
                    {maternity.length > 0 &&
                      maternity.map((mat) => (
                        <div className="col-lg-6" key={mat._id}>
                          <ul>
                            <li>{mat.condition}</li>
                          </ul>
                          <div
                ...
                <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 mb-3">
                  <div className="row">
                    ...
                    >
                      <Link
                        to="/Individualinsuranceunderwriting"
                        className="buttonactions"
